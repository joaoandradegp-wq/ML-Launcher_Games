...
type
  TForm1 = class(TForm)
    ...
    Panel1: TPanel;
    Registro1: TMenuItem;
    procedure monkey1Click(Sender: TObject);
    procedure monkey2Click(Sender: TObject);
...
Form1.id:=Game;
  ...
  case Game of
  1: Form1.SELECT.Left:=Form1.monkey1.Left;
  2: Form1.SELECT.Left:=Form1.monkey2.Left;
  end;
...
AbfWav1.FileName:=DIR_App+'BIN\monkey_voice.wav';
StatusBar1.Panels[1].Text:='© '+IntToStr(YearOf(Date))+', JMBA Softwares. Todos os direitos reservados.';
end;

procedure TForm1.monkey1Click(Sender: TObject);
begin
Selecao(1);
end;

procedure TForm1.monkey2Click(Sender: TObject);
begin
Selecao(2);
end;
...
Sleep(4000);
//-------------------------------------
btn_jogar.Caption:='MONKEY ISLAND';
